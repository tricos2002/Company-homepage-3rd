  ...
  en: {
    translation: {
      ...
      services: {
        ...
        tagline: "Bridging the gap between domestic businesses and global markets.",
  ...
  ko: {
    translation: {
      ...
      services: {
        ...
        promotion: "판촉/홍보행사",
        support: "수출입지원",
        tagline: "해외진출, 처음부터 끝까지 트리코스가 함께합니다",
        cta: "상담 신청하기"
      },
      contact: {
        title: "문의하기",
  ...
  ru: {
    translation: {
      ...
      services: {
        ...
        tagline: "Tricos сопровождает вас на каждом этапе выхода на зарубежные рынки.",
