        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="glass-card p-8 md:p-12 flex flex-col items-center justify-center text-center space-y-6 border-t md:border-t-0 md:border-l border-white/5">
              ...
              <div>
                <h3 className="text-2xl font-bold text-white mb-3">{t('contact.mapTitle')}</h3>
              ...
              >
                {t('contact.mapButton')} <ChevronRight size={20} className="group-hover:translate-x-1 transition-transform" />
              </a>
            </div>
          </motion.div>
        </div>
